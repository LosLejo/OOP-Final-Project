...
def runCombi(title, surface):
    ...
    bg = pygame.image.load("Assets\\backgrounds\\combi bg.png").convert_alpha()
    ...
    while runC:
        ...
        #   set title
        title = pygame.display.set_caption("Counting Principle : Combination")
